...
public record class Event
{
    ...
    public Trail Trail { get; set; } = new();               // 步伐信息
    ...
    [JsonIgnore]
    public bool InVanishTime => Trigger.VanishTime > 0;
    [JsonIgnore]
...
{
    public AddressBase Trigger { get; set; } = null!;       // 触发脚本
    public AddressBase Auto { get; set; } = null!;          // 自动脚本
