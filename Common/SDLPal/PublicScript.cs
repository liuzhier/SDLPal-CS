...
public static unsafe partial class PalScript
{
    ...
    public static int RunPublic(int address, int sceneId, int eventId)
    {
        ...
        if (args.Length >= 1)
        {
            ...
            heroBase = save.Entity.Heroes[heroTeamId];
        }
        ...
        if (args.Length >= 2)
        {
            ...
            // 获取步伐数据
            //
            eventTrail = currentEvent?.Sprite.Trail;
        }
        ...
        switch (cmd)
        {
            ...
            case 0x0087:
                ...
                */
                if (args[0].Direction != PalDirection.Current)
                    @event.Sprite.Trail.Direction = args[0].Direction;
            ...
            case 0x000F:
                ...
                */
                if (args[0].Direction != PalDirection.Current) @event.Sprite.Trail.Direction = args[0].Direction;
                if (args[1].Int != -1) @event.Sprite.Trail.FrameId = args[1].Int;
                break;
            ...
            case 0x0014:
                ...
                */
                @event.Sprite.Trail.FrameId = args[0].Int;
                @event.Sprite.Trail.Direction = PalDirection.South;
                break;
                ...
                */
                if (args[0].Bool)
                    ...
                    for (var i = 0; i < save.HeroTeamLength; i++)
                        S.HeroModifyHPMP(S.GetMember(i).HeroId, args[1].Int, args[1].Int);
                else
                    //
                    // 作用于单人
                    // 参数“eventId”代表 HeroId
                    //
                    if (!S.HeroModifyHPMP(eventId, args[1].Int, args[1].Int)) ScriptSuccess = false;
                break;
            ...
            case 0x001F:
                ...
                */
                S.InventoryAddItem(args[0].Int, args[1].Bool ? args[1].Int : 1);
                break;
                ...
                */
                {
                    ...
                    // 统计此物品的实际存量数量
                    //
                    if (num <= S.InventoryCountItem(itmeId) || (args[3].Address == 0))
                    {
                        if (!S.InventoryAddItem(itmeId, -num).IsSuccess)
                        {
                            //
                            // 尝试删除已装备的物品
                            //
                            for (var i = 0; i <= save.HeroTeamLength; i++)
                            {
                                var heroId = S.GetMember(i).HeroId;
                                var hero = S.Entity.Heroes[heroId];

                                var pEquip = (int*)&hero.Raw->Equipment;
                                for (var equipId = 0; equipId < Base.MaxHeroEquipments; equipId++)
                                {
                                    if (pEquip[equipId] == itmeId)
                                    {
                                        //
                                        // 将此装备从团队成员身上删除
                                        //
                                        ...
                                        S.RemoveEquipmentEffect(heroId, (EquipmentPart)equipId);

                                        if (--num == 0) goto case_0x0020_end;
                                    }
                                }
                            }
                        }
            ...
            case 0x0024:
                ...
                */
                if (args[1].Event != 0) currentEvent!.Script.Auto = args[2].Address;
                break;
            ...
            case 0x0025:
                ...
                * @param scrAddress 欲设置的脚本地址
                */
                if (args[1].Event != 0) currentEvent!.Script.Trigger = args[2].Address;
                break;
            ...
            case 0x0097:
                ...
                * @param speed 行驶速度
                */
                PalScene.PartyRideEventObject(sceneId, eventId, bposTmp, args[3].Int);
                break;
            ...
            case 0x0052:
                ...
                */
                @event.Trigger.StateCode = (Core.EventState)((short)@event.Trigger.StateCode * -1);
                @event.Sprite.VanishTime = (args[0].Int != 0) ? args[0].Int : 800;
                break;
            ...
            case 0x0055:
                ...
                */
                S.RoleAddMagic(args[1].Int, args[0].Int);
                break;
            ...
            case 0x0065:
                ...
                */
                S.Entity.Heroes[args[0].Int + 1].Raw->SpriteId = args[1].Int;
            ...
            case 0x006D:
                ...
                */
                if (args[0].Int != 0)
                {
                    ...
                    if (args[1].Address != 0) scene.Script.Enter = args[1].Address;
                    if (args[2].Address != 0) scene.Script.Teleport = args[2].Address;
                }
                break;
            ...
            case 0x0075:
                ...
                */
                ...
                foreach (var heroIdChar in args[0].String)
                {
                    ...
                    var heroTeam = save.HeroTeams[count];
                    heroTeam.HeroId = heroId;
                    heroTeam.Trail.Direction = S.GetHeroTeamDirection();
