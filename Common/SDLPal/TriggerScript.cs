        ...
        while (address != 0 && !ended)
        {
            ...
            switch (command)
            {
                ...
                case 0x003B:
                    ...
                    */
                    PalDialog.ClearMesssge(true);
                    PalDialog.InitMesssge(PalDialogPosition.Middle, color: S.StrToUInt32(args[0].String), isPlayingRng: args[1].Bool);
                    address++;
                    break;
                ...
                case 0x003C:
                    ...
                    */
                    PalDialog.ClearMesssge(true);
                    PalDialog.InitMesssge(PalDialogPosition.Top, color: S.StrToUInt32(args[1].String), faceId: args[0].Int, isPlayingRng: args[2].Bool);
                    address++;
                    break;
                ...
                case 0x003D:
                    ...
                    */
                    PalDialog.ClearMesssge(true);
                    PalDialog.InitMesssge(PalDialogPosition.Bottom, color: S.StrToUInt32(args[1].String), faceId: args[0].Int, isPlayingRng: args[2].Bool);
                    address++;
                    break;
                ...
                case 0x003E:
                    ...
                    */
                    PalDialog.ClearMesssge(true);
                    PalDialog.InitMesssge(PalDialogPosition.Middle, color: S.StrToUInt32(args[0].String));
                    address++;
                    break;
