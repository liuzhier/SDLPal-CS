...
declare global {
    ...
    */
    function RoleRevive(applyToAll: boolean, value: Rate100): void;
    ...
    */
    function SetDlgCenter(colorHex: string, rngPlaying: boolean): void;
    ...
    */
    function SetDlgUpper(faceId: ushort, colorHex: string, rngIsPlaying: boolean): void;
    ...
    * @param rngIsPlaying 是否正在播放 Rng 动画
    */
    function SetDlgLower(faceId: ushort, colorHex: string, rngIsPlaying: boolean): void;
    ...
    * @param colorHex 调色板颜色字符串，支持 Dec Hex，示例："0xFF0000"（红色）
    */
    function SetDlgBox(colorHex: string): void;
    ...
    */
    function SetTimeFilter(filter: Filter): void;
    // 0[0=0x0053, 3=0x0054]
    ...
    * 
    * @note
    * -  设置当前敌人的法术为 {magicId}，施法概率百分之 {rate}
    * 
    * @param magicId 仙术编号（0 = 只能普攻；-1 = 只能普攻，且有百分之 {rate} 概率本回合不行动）
    * @param rate 施法概率百分比，缺省则为 10
    */
    function EnemySetMagic(magicId: short, rate: Rate100): void;
    // Ts(0@MagicEntity, 1)
    // Cmd(0@MagicEntity, 1)
    ...
    * 
    * @note
    * -  当前队员偷窃当前敌人，成功率百分之 {rate}
    * 
    * @param rate 偷窃成功的概率百分比
    */
    function BattleStealFromEnemy(rate: Rate100): void;
    ...
    */
    function PartySetRole(roles: string): void;
    ...
    */
    function ChangeDayAndNight(applyImmediately: boolean): void;
    ...
    * @param msg 对话内容
    */
    function Dialogue(msg: string): void;
