...
public static unsafe class Spirit
{
    ...
    public static void Process()
    {
        ...
        // 输出处理进度
        //
        S.Log("Unpack the game data. <Spirit>");
        ...
        S.Log("Unpack the game data. <Spirit: DialogueCursor>");
        ProcessPack(Config.WorkPath.DataBase.Base, spirit.Ui.DialogueCursor, beginId: 12, endId: 12, isCompressedPack: false, haveSubPath: false);
    }
}
