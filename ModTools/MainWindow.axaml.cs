...
public partial class MainWindow : Window
{
    ...
    private async void GamePath_PathBox_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        ...
        if ((path = await Util.PathSelector(this, "Select the game path")) != null)
    ...
    private async void ModPath_PathBox_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        ...
        if ((path = await Util.PathSelector(this, "Select the unpacking path for the game mod")) != null)
    ...
    private async void CompiledPath_PathBox_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        ...
        if ((path = await Util.PathSelector(this, "Select the path of the game mod compilation result")) != null)
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void UnpackButton_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        //
        // 禁止与所有控件互动
        //
        ...
        Task.Run(() =>
        {
            ModMain.GoUnpack(_gamePath, _modPath);
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void BaseData_CheckBox_IsCheckedChanged(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        CheckBox?       checkBox;
        CheckBox[]      checkBoxs;
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void CoreData_CheckBox_IsCheckedChanged(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        CheckBox?       checkBox;
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void SelectAll_Button_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void Compile_Button_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
        int     isCheckedCount;
        ...
        if (isCheckedCount == 0)
            ...
            // 提示用户先勾选编译选项
            //
            Util.MsgBox("Please select the item you want to compile first!");
        else
        {
            //
            // 禁止与所有控件互动
            ...
            Task.Run(() =>
            {
                ModMain.GoCompile(_modPath, _compiledPath, _compiledVersion);
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void MsgBox_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e) =>
