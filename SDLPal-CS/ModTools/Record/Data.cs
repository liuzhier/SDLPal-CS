...
public static unsafe class Data
{
    ...
    {
        public  ushort      AttackStrength;     // 武术
        public  ushort      MagicStrength;      // 灵力
        public  ushort      Defense;            // 防御
        public  ushort      Dexterity;          // 身法
        public  ushort      FleeRate;           // 吉运
    }
    ...
    {
        public  fixed   ushort      AttackStrength[MaxHero];        // 武术
        public  fixed   ushort      MagicStrength[MaxHero];         // 灵力
        public  fixed   ushort      Defense[MaxHero];               // 防御
        public  fixed   ushort      Dexterity[MaxHero];             // 身法
        public  fixed   ushort      FleeRate[MaxHero];              // 吉运
    }
