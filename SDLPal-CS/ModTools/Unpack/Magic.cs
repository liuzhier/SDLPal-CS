...
public static unsafe class Magic
{
    ...
    public static void Process()
    {
        ...
        indexContent = new string[end - (int)EntityBeginId.Magic];
        for (i = (int)EntityBeginId.Magic, j = 0; i < end; i++, j++)
        {
            //
            // 获取当前 Magic
            //
            ...
            magic = new RGame.Magic(
                ...
                Scope: new RGame.MagicScope(
                    ...
                    ApplyToAll: (mask & MagicMask.ApplyToAll) != 0
                )
            );
